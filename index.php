<?php
// index.php - High-Contrast Advanced Ultra-Premium Landing Page
$pageTitle = "Digital Internship System - Career & Internship Platform";
require_once __DIR__ . '/includes/header.php';
require_once __DIR__ . '/includes/navbar.php';
?>

<!-- SECTION 1: HOME (HERO BANNER WITH HIGH CONTRAST READABILITY) -->
<section id="home" class="py-5 bg-white position-relative overflow-hidden border-bottom">
  <div class="container py-5 text-center position-relative" style="z-index: 2;">
    ...
    <div class="d-inline-flex align-items-center gap-2 px-4 py-2 rounded-pill bg-indigo-50 text-indigo-700 font-weight-extrabold small mb-4 border border-indigo-200 shadow-sm">
      ...
      Advanced Enterprise Internship Management Engine
    </div>

    <h1 class="display-3 font-weight-extrabold mb-3 text-dark-contrast tracking-tight">
      Empowering Students, Supervisors & <span class="gradient-text-mask">Industry Partners</span>
    </h1>
    <p class="lead mb-4 max-w-3xl mx-auto text-dark-contrast opacity-90 fs-4 fw-semibold">
      Streamlining university internship allocations, physical onsite interview schedules, workplace supervisor task tracking, and performance evaluations.
    </p>

    <div class="d-flex justify-content-center gap-3 mb-5">
      <a href="signup.php" class="btn btn-adv-primary shadow-lg">
        <i class="fas fa-rocket me-2"></i> Register Account
      </a>
      <a href="#browse-internships" class="btn btn-adv-secondary shadow-sm">
    ...
    <div class="row g-4 max-w-4xl mx-auto pt-3">
      <div class="col-6 col-md-3">
        <div class="adv-card p-4 text-center">
          ...
          <p class="text-dark-contrast font-weight-extrabold mb-0 small">Students Placed</p>
        </div>
      </div>
      <div class="col-6 col-md-3">
        <div class="adv-card p-4 text-center">
          <h3 class="font-weight-extrabold mb-1 text-info fs-1">350+</h3>
          <p class="text-dark-contrast font-weight-extrabold mb-0 small">Verified Companies</p>
        </div>
      </div>
      <div class="col-6 col-md-3">
        <div class="adv-card p-4 text-center">
          <h3 class="font-weight-extrabold mb-1 text-success fs-1">98.5%</h3>
          <p class="text-dark-contrast font-weight-extrabold mb-0 small">Completion Rate</p>
        </div>
      </div>
      <div class="col-6 col-md-3">
        <div class="adv-card p-4 text-center">
          <h3 class="font-weight-extrabold mb-1 text-warning fs-1">100%</h3>
          <p class="text-dark-contrast font-weight-extrabold mb-0 small">Verified Records</p>
        </div>
      </div>
    </div>
  ...
  <div class="container py-4">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4">
      <div>
        ...
        <p class="text-dark-contrast fw-semibold mb-0 fs-6">High-value software engineering, product design, and AI positions.</p>
      </div>
      <a href="signin.php" class="btn btn-adv-secondary font-weight-bold mt-2 mt-md-0">
    ...
    <div class="d-flex flex-wrap gap-2 mb-4">
      <button onclick="filterLandingCategory('all')" class="btn btn-adv-primary btn-sm active" id="btn-cat-all">All Positions</button>
      <button onclick="filterLandingCategory('Software Development')" class="btn btn-adv-secondary btn-sm" id="btn-cat-software">Software Development</button>
      <button onclick="filterLandingCategory('UI/UX Design')" class="btn btn-adv-secondary btn-sm" id="btn-cat-uiux">UI/UX Design</button>
      <button onclick="filterLandingCategory('Data Science')" class="btn btn-adv-secondary btn-sm" id="btn-cat-data">Data Science</button>
    </div>
    ...
    <div class="row g-4" id="landing-internships-grid">
        ...
        <div class="adv-card p-4 h-100 d-flex flex-column justify-content-between">
          <div>
            <div class="d-flex justify-content-between align-items-center mb-3">
              <span class="badge badge-adv badge-adv-primary"><i class="fas fa-code me-1"></i> Software Dev</span>
              <small class="text-dark-contrast font-weight-extrabold"><i class="far fa-clock me-1 text-primary"></i> Sep 30, 2026</small>
            </div>
            ...
            <p class="text-dark-contrast font-weight-medium small mb-4">Develop dynamic PHP & MySQL web applications using Bootstrap 5 and modern REST architecture.</p>
          </div>
          <div class="pt-3 border-top d-flex justify-content-between align-items-center">
            ...
            <a href="signin.php" class="btn btn-adv-primary btn-sm">Apply Role</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4 internship-card-item" data-cat="UI/UX Design">
        <div class="adv-card p-4 h-100 d-flex flex-column justify-content-between">
          <div>
            <div class="d-flex justify-content-between align-items-center mb-3">
              <span class="badge badge-adv badge-adv-success"><i class="fas fa-palette me-1"></i> UI/UX Design</span>
              <small class="text-dark-contrast font-weight-extrabold"><i class="far fa-clock me-1 text-success"></i> Oct 15, 2026</small>
            </div>
            ...
            <p class="text-dark-contrast font-weight-medium small mb-4">Design responsive user interfaces, wireframes, and interactive user prototypes for enterprise products.</p>
          </div>
          <div class="pt-3 border-top d-flex justify-content-between align-items-center">
      ...
      <div class="col-md-6 col-lg-4 internship-card-item" data-cat="Data Science">
        <div class="adv-card p-4 h-100 d-flex flex-column justify-content-between">
          <div>
            <div class="d-flex justify-content-between align-items-center mb-3">
              <span class="badge badge-adv badge-adv-warning"><i class="fas fa-chart-bar me-1"></i> Data Science</span>
              <small class="text-dark-contrast font-weight-extrabold"><i class="far fa-clock me-1 text-warning"></i> Nov 05, 2026</small>
            </div>
            ...
            <p class="text-dark-contrast font-weight-medium small mb-4">Process structured business data datasets and generate analytical visual dashboards for decision makers.</p>
          </div>
          <div class="pt-3 border-top d-flex justify-content-between align-items-center">
...
<section id="about" class="bg-white py-5 border-top border-bottom">
  <div class="container py-4">
    <div class="text-center max-w-3xl mx-auto mb-5">
      ...
      <p class="text-dark-contrast font-weight-semibold fs-6">A complete web platform built for all 4 key user roles in the internship lifecycle.</p>
    </div>

    <div class="row g-4">
      <div class="col-md-6 col-lg-3">
        <div class="adv-card p-4 text-center h-100" style="border-top: 4px solid #4f46e5;">
          ...
          <p class="text-dark-contrast font-weight-medium small mb-0">Browse verified internships, apply with CV attachments, view onsite interview dates & venue address, and submit weekly logs.</p>
        </div>
      </div>

      <div class="col-md-6 col-lg-3">
        <div class="adv-card p-4 text-center h-100" style="border-top: 4px solid #0284c7;">
          ...
          <p class="text-dark-contrast font-weight-medium small mb-0">Post opportunities, shortlist applicant CVs, schedule physical onsite interviews, and register workplace supervisors.</p>
        </div>
      </div>

      <div class="col-md-6 col-lg-3">
        <div class="adv-card p-4 text-center h-100" style="border-top: 4px solid #059669;">
          ...
          <p class="text-dark-contrast font-weight-medium small mb-0">Assign workplace tasks with deadlines, review intern learning reports, and evaluate performance with 1-5 star ratings.</p>
        </div>
      </div>

      <div class="col-md-6 col-lg-3">
        <div class="adv-card p-4 text-center h-100" style="border-top: 4px solid #d97706;">
          ...
          <p class="text-dark-contrast font-weight-medium small mb-0">Manage system user accounts, verify company registration certificates, audit internship completions, and export CSV reports.</p>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="adv-card p-0 overflow-hidden">
          ...
          <div class="p-4 p-md-5">
            <form onsubmit="handleContactSubmit(event)">
              ...
              <button type="submit" class="btn btn-adv-primary w-100 py-3 font-weight-bold">
