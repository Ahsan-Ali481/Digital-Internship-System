<?php
// dashboard-supervisor.php - High Contrast Supervisor Portal with 30% Flat Professional Sidebar (50% Pill Hover)
    ...
    <div class="col-md-4 col-lg-3 p-0" id="sidebar-wrapper">
      <div class="professional-sidebar-panel">
        ...
        <div class="text-center p-4 border-bottom">
          <div class="rounded-circle mx-auto d-flex align-items-center justify-center mb-3 shadow-sm" style="width: 76px; height: 76px; background-color: #d1fae5; border: 3px solid #059669;">
            <i class="fas fa-user-check fa-2x text-success"></i>
          </div>
          <h5 class="fw-black text-black mb-1"><?php echo htmlspecialchars($currentSup['name']); ?></h5>
          ...
          <div class="d-flex flex-column gap-2 mb-2">
            <button onclick="switchSupTab('tasks')" class="btn-prof-action">
              <i class="fas fa-user-cog me-1"></i> Edit Profile
            </button>
            <button onclick="switchSupTab('reports')" class="btn-prof-action">
              <i class="fas fa-tasks me-1"></i> Evaluation Logs
            </button>
          </div>
          <span class="badge badge-black-pill badge-emerald py-1 px-3 extra-small">
            <i class="fas fa-shield-alt me-1 text-success"></i> Institution Supervisor
          </span>
        </div>

        <!-- 100% Flat Module Items (No Border Box lines in default state) -->
        <div class="prof-sidebar-scroll p-3 d-flex flex-column gap-2">
          <button onclick="switchSupTab('tasks')" class="sidebar-pill-link active" id="link-sup-tasks">
            <i class="fas fa-tasks"></i> <span>Assign Tasks</span>
          </button>
          <button onclick="switchSupTab('reports')" class="sidebar-pill-link" id="link-sup-reports">
            <i class="fas fa-clipboard-check"></i> <span>Review Logs</span>
          </button>
