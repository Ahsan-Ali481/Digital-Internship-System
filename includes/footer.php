<?php
// includes/footer.php - Global Footer Component with Navigation Links & Social Media Icons
?>
    ...
    <div class="row g-4 pb-3">
      ...
      <div class="col-md-3">
        ...
        <ul class="list-unstyled text-small small mb-0">
          ...
          <li class="mb-1"><a href="index.php#how-it-works" class="text-white-50 text-decoration-none"><i class="fas fa-chevron-right me-1 text-primary"></i> How It Works</a></li>
          <li class="mb-1"><a href="index.php#about" class="text-white-50 text-decoration-none"><i class="fas fa-chevron-right me-1 text-primary"></i> User Roles</a></li>
      ...
      <div class="col-md-2">
        ...
        <ul class="list-unstyled text-small small mb-0">
          <li class="mb-1"><a href="signin.php" class="text-white-50 text-decoration-none"><i class="fas fa-sign-in-alt me-1 text-warning"></i> Sign In</a></li>
          <li class="mb-1"><a href="signup.php" class="text-white-50 text-decoration-none"><i class="fas fa-user-plus me-1 text-success"></i> Register Account</a></li>
      ...
      <div class="col-md-3">
        ...
        <ul class="list-unstyled text-small small text-white-50 mb-0">
